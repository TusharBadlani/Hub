package cessini.technology.commonui.presentation.storydisplay.fragment
...
import cessini.technology.commonui.presentation.storydisplay.adapter.CommonStoryDisplayAdapter
...
class CommonStoryDisplayFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("CheckNav", "CommonStoryDisplayFrag, ${activity?.localClassName}")
